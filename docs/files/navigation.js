	...
	$.fn.responsiveMenu = function(options) {
		...
		function widthChange(mq) {
			if (mq.matches) {
				...
				$menu.find('li.menu-item-has-children > a').on('focus.aria mouseenter.aria',
				function() {
				...
				$menu.find('li.menu-item-has-children > a').on('blur.aria  mouseleave.aria',
				function() {
		...
		$menu.find('.submenu-dropdown-toggle').on('click',
		function() {
